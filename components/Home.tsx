    ...
    <section id="home">
      ...
      <div id="headDesc">
        ...
        <article className="textBlocks" id="homeDescription">
          ...
          Typescript in a React.js environment. My resume can be viewed and
          downloaded witin the &quot;Resume&quot; section. Screenshots,
          descriptions and links to my previous projects and their associated
          GitHub respositories can also be found within the &quot;Projects&quot;
          section.
        </article>
      </div>
    </section>
